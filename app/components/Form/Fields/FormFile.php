...
trait FormFile
{
     ...
     * @return string
     */
    public static function getFile(string $title, string $name = null, array $options = [], bool $with_edit = false): string
    {
        ...
        <div class="form-group">
            ...
            <?= $with_edit ? self::getConfigButtons(self::TYPE_FILE) : null ?>
            <input <?= $attributes ?> />
        </div>
        <?
